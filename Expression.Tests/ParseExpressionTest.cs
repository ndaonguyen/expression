...
namespace Expression.Tests
{
    public class ParseExpressionTest
    {
        ...
        public void TestParser()
        {
            ...
            var expressionNode = Parser.Parser.ParseExpression("x").Value!;
        ...
        public void TestParser1()
        {
            ...
            var expressionNode = Parser.Parser.ParseExpression("3").Value!;
        ...
        public void TestParser2()
        {
            // input : x+3
            // output: AddNode: x+3
            var expressionNode = Parser.Parser.ParseExpression("(x+3)").Value!;
        ...
        public void TestParser3()
        {
            ...
            var expressionNode = Parser.Parser.ParseExpression("((x+3)*(x+1))").Value!;
        ...
        public void TestParser4()
        {
            ...
            var expressionNode = Parser.Parser.ParseExpression("((1+2+1)*(1+1)*x)").Value!;
        ...
        public void TestParser5()
        {
            ...
            var expressionNode = Parser.Parser.ParseExpression("(1+(2*x)+1)").Value!;
        ...
        public void TestParser6()
        {
            ...
            var expressionNode = Parser.Parser.ParseExpression("((1+(2*x)+1)*(x+1))").Value!;
        ...
        public void TestParserFail1()
        {
            // input : ((x+3)*(x+1)
            // output: fail
            var expressionNodeResult = Parser.Parser.ParseExpression("((x+3)*(x+1)");
